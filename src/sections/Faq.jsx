    ...
    <section className="w-[95%] lg:w-9/12 mx-auto mt-3">
      ...
      {faq.map(({ question, answer }, index) => (
        <div key={question} className={"flex flex-col gap-3"}>
          <p
            className={`
              bg-l1 cursor-pointer after:font-bold after:text-3xl after:text-p12 after:hover:text-p30 transition-colors duration-500 flex justify-between p-3 text-base lg:text-xl rounded-md
            `}
